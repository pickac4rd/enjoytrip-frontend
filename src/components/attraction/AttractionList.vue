...
export default {
  created() {
    ...
    this.$store.dispatch("attractionStore/" + Constant.SEARCH, {offset: 1, limit:6, sido_code: undefined,gugun_code: undefined,content_type_id: undefined,title: undefined});
